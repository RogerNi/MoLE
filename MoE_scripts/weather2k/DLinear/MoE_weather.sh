    ...
    do
        ...
        do
            ...
            #     do
                ...
                --is_training 1 \
                --root_path ./dataset/weather2k/ \
                --data_path $data_idx.csv \
                --model_id weather2k$data_idx'_'336'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim \
                --model TDLinear \
                --data custom \
                --features M \
                --seq_len 336 \
                ...
                --t_dim $t_dim \
                --target vv\
                --learning_rate $lr >logs/new_datasets/weather2k/DLinear/weather2k$data_idx'_'336'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                # done
            # done
        done
    done
