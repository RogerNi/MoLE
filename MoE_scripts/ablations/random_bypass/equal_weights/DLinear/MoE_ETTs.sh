...
mkdir -p logs/ablations/random_bypass/equal_weights/DLinear/$head_dropout
    ...
    do
        ...
        do
            ...
            #     do
                ...
                --learning_rate $lr >logs/ablations/random_bypass/equal_weights/DLinear/ETT$ett'_'$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                # done
            # done
        done
    done
