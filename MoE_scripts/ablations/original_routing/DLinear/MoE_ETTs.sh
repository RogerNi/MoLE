    ...
    do
        ...
        do
            ...
            #     do
                ...
                if [[ -z "${SEED}" ]]; then
                  MY_SEED="2021"
                  LOG_FILE=logs/ablations/original_routing/DLinear/ETT$ett'_'$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                else
                  MY_SEED="${SEED}"
                  mkdir -p logs/ablations/original_routing/DLinear/$MY_SEED
                  LOG_FILE=logs/ablations/original_routing/DLinear/$MY_SEED/ETT$ett'_'$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                fi
