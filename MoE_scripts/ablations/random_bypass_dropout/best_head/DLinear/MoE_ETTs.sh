    ...
    do
        ...
        do
            ...
            #     do
                ...
                --learning_rate $lr >logs/ablations/random_bypass_dropout/best_head/DLinear/$head_dropout/ETT$ett'_'$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                # done
            # done
        done
    done
