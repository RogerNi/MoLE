...
mkdir -p logs/ablations/random_bypass_dropout/equal_weights/DLinear/$head_dropout
    ...
    do
        ...
        do
            ...
            #     do
                ...
                --use_equal_weighting_in_testing_time \
                --head_dropout $head_dropout \
                --learning_rate $lr >logs/ablations/random_bypass_dropout/equal_weights/DLinear/$head_dropout/ETT$ett'_'$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                # done
            # done
        done
    done
