    ...
    do
        ...
        do
            ...
            #     do
                ...
                --learning_rate $lr >logs/ablations/random_bypass_dropout/equal_weights/DLinear/$head_dropout/weather_$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                # done
            # done
        done
    done
