    ...
    do
        ...
        do
            ...
            #     do
                ...
                if [[ -z "${SEED}" ]]; then
                  MY_SEED="2021"
                  LOG_FILE=logs/ablations/random_routing_dropout/DLinear/$head_dropout/traffic_$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                else
                  MY_SEED="${SEED}"
                  mkdir -p logs/ablations/random_routing_dropout/DLinear/$head_dropout/$MY_SEED
                  LOG_FILE=logs/ablations/random_routing_dropout/DLinear/$head_dropout/$MY_SEED/traffic_$MY_SEQ_LEN'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                fi
