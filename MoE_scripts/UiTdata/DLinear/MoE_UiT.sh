    ...
    do
        ...
        do
            ...
            #     do
                ...
                --is_training 1 \
                --root_path ./dataset/ \
                --data_path UiTdata_$data_idx.csv \
                --model_id UiTdata$data_idx'_'336'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim \
                --model TDLinear \
                --data custom \
                --features M \
                --seq_len 336 \
                ...
                --t_dim $t_dim \
                --freq t\
                --learning_rate $lr >logs/new_datasets/UiTdata//DLinear/UiTdata$data_idx'_'336'_'$pred_len'_'$aug_method'_'$aug_rate'_'$lr'_'$t_dim.log
                # done
            # done
        done
    done
